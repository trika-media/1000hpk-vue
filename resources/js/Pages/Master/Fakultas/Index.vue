...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <template #button>
            ...
            <div class="btn-group ms-2 ms-lg-3">
                <button
                    ...
                    data-bs-target="#modal-import-fakultas"
                >
                    Import
                </button>

                <a
                    :href="route('excel.export.fakultas')"
                    type="button"
                    class="btn btn-sm btn-outline-gray-600"
                >
                    Export
        ...
        <ImportModal
            target="modal-import-fakultas"
            title="Import Data Fakultas"
            template="fakultas.xlsx"
            route="excel.import.fakultas"
        />
    </AuthenticatedLayout>
</template>
