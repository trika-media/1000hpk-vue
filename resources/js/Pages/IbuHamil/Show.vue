            ...
            <ul class="list-group">
                ...
                <li class="list-group-item border-bottom p-3">
                    <div>
                        ...
                        <ul>
                            <li class="h6" v-for="keluhan in ibuhamil.keluhan" :key="keluhan.id">{{ keluhan.penyakit.nama || keluhan.nama_penyakit }}</li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="list-group-item border-bottom p-3" v-if="ibuhamil.lat && ibuhamil.lng">
                    <div>
                        <div class="small text-muted pe-4">Latitude/Longitude</div>
                        <h3 class="h6">{{ ibuhamil.lat }}/{{ ibuhamil.lng }}</h3>
                        ...
                        <div class="position-relative">
                            ...
                            >
                                ...
                                <LMarker :lat-lng="[ibuhamil.lat, ibuhamil.lng]">
                                    <LTooltip>Lokasi Ibu Hamil : {{ ibuhamil.nama }}</LTooltip>
                                </LMarker>
                            </LMap>
                        </div>
                    </div>
