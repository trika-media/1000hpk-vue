...
const form = useForm({
    identitas: props.ibuHamil.identitas,
    nama: props.ibuHamil.nama,
    alamat: props.ibuHamil.alamat,
    nomor_ponsel: props.ibuHamil.nomor_ponsel,
    tanggal_lahir: props.ibuHamil.tanggal_lahir,

    puskesmas: props.ibuHamil.puskesmas_id,
    keluhan: props.ibuHamil.keluhan_arr,

    provinsi: props.ibuHamil.provinsi_id,
    kabupaten: props.ibuHamil.kabupaten_id,
    kecamatan: props.ibuHamil.kecamatan_id,
    kelurahan: props.ibuHamil.kelurahan_id,

    lat: props.ibuHamil.lat,
    lng: props.ibuHamil.lng,

    mahasiswa: props.ibuHamil.mahasiswa_id,
});
...
const setPosition = (position) => {
    ...
    location.value.lat = props.ibuHamil.lat;
    location.value.lng = props.ibuHamil.lng;
};
...
const submit = () => {
    form.put(route("ibu-hamil.update", { ibu_hamil: props.ibuHamil.id }));
};
</script>

<template>
    <Head title="Sunting Ibu Hamil" />

    <AuthenticatedLayout>
        <template #heading> Sunting Data Ibu Hamil </template>

        <template #subheading> Menyunting data ibu hamil. </template>
