...
const destroy = (id) => {
    ...
    Inertia.delete(route("user.ibu-hamil.destroy", { id }));
};
</script>
...
<template>
    ...
    <AuthenticatedLayout>
        <template #heading> Ibu Hamil </template>

        <template #subheading> Kumpulan data ibu hamil. </template>

        <template #button>
            <Link
                :href="route('user.ibu-hamil.create')"
                ...
                >
                    ...
                    <tbody>
                        <Rows :data="ibuhamil.data" colspan="7">
                            <tr
                                v-for="(ibuhamil, index) in ibuhamil.data"
                                :key="ibuhamil.id"
                            >
                                <td>{{ index + 1 }}</td>
